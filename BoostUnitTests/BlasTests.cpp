...
namespace SEPOLIA4::BOOST_UNIT_TEST_BLAS
{
	BOOST_AUTO_TEST_SUITE(BLAS_TESTS)
		...
		BOOST_AUTO_TEST_CASE(TEST_CBLAS_DGEMV_aAX_1_USING_MATRIX_VECTOR)
		{
			const int32_t NROWS = 4;
			const int32_t NCOLS = 5;
			...
			// y = Ax //
			//========//
			cblas_dgemv(CblasRowMajor, CblasNoTrans, NROWS, NCOLS, alpha, &A(0,0), NCOLS, &x[0], 1, beta, &y[0], 1);
		...
		BOOST_AUTO_TEST_CASE(TEST_CBLAS_DGEMV_aAX_2_USING_MATRIX_VECTOR)
		{
			const int32_t NROWS = 1;
			const int32_t NCOLS = 5;
		...
		BOOST_AUTO_TEST_CASE(TEST_CBLAS_DGEMV_aAX_3_USING_MATRIX_VECTOR)
		{
			const int32_t NROWS = 5;
			const int32_t NCOLS = 1;
		...
		BOOST_AUTO_TEST_CASE(TEST_CBLAS_DGEMV_aAX_plus_bY_USING_MATRIX_VECTOR)
		{
			const int32_t NROWS = 4;
			const int32_t NCOLS = 5;
